...
export default function Menu() {
  return (
    <div>
      <div>
        <NavLink className="checkCart" to="/cart">
          {" "}
          Checkout Cart
        </NavLink>
      </div>
      <div className="menu">
        <h1 class="menuheader" align="center">
          FULL MENU
        </h1>

        <div class="container2">
          <div class="menu">
            <h2 class="menu-group-heading">Soups</h2>
            ...
            <br></br>
            <h2 class="menu-group-heading">Kitchen Appetizers</h2>
            <div class="menu-group">
              <div class="menu-item">
                <div class="menu-item-text">
                  <h3 class="menu-item-heading">
            ...
            <br></br>
            <h2 class="menu-group-heading">Sushi Appetizers</h2>
            <div class="menu-group">
              <div class="menu-item">
                <div class="menu-item-text">
                  <h3 class="menu-item-heading">
            ...
            <br></br>
            <h2 class="menu-group-heading">Fish Fillets</h2>
            <div class="menu-group">
              <div class="menu-item">
                <div class="menu-item-text">
                  <h3 class="menu-item-heading">
            ...
            <br></br>
            <h2 class="menu-group-heading">Signature Rolls</h2>
            <div class="menu-group">
              <div class="menu-item">
                <div class="menu-item-text">
                  <h3 class="menu-item-heading">
